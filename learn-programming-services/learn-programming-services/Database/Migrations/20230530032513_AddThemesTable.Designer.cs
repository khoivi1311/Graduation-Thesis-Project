...
namespace learn_programming_services.Database.Migrations
{
    ...
    [Migration("20230530032513_AddThemesTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("learn_programming_services.Database.Entity.CodeLanguages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 5, 22, 6, 50, 15, 143, DateTimeKind.Unspecified).AddTicks(8690),
                            Name = "C",
                            SubmitName = "c",
                            UpdateDate = new DateTime(2023, 5, 22, 6, 50, 15, 143, DateTimeKind.Unspecified).AddTicks(8690),
                            Version = "11.3.0"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("learn_programming_services.Database.Entity.CourseVotes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("learn_programming_services.Database.Entity.LessonCodeSamples", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int>("CodeLanguageId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("learn_programming_services.Database.Entity.Themes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("learn_programming_services.Database.Entity.LessonCodeSamples", b =>
                {
                    b.HasOne("learn_programming_services.Database.Entity.CodeLanguages", "CodeLanguage")
                        .WithMany("LessonCodeSamples")
            ...
            modelBuilder.Entity("learn_programming_services.Database.Entity.CodeLanguages", b =>
                {
                    b.Navigation("LessonCodeSamples");
